...
document.write(`<br>Q1: $${Q1}</br>`);
document.write(`\nQ2: $${Q2}`);
document.write(`<br>Q3: $${Q3}</br>`);
document.write(`\nQ4: $${Q4}`);

//Print Sales by Region section
document.write(`<h2>Sales by Region</h2>`);
document.write(`<br>Region 1: $${R1}</br>`);
document.write(`\nRegion 2: $${R2}`);
document.write(`<br>Region 3: $${R3}</br>`);
document.write(`\nRegion 4: $${R4}`)
document.write(`<br>Region 5: $${R5}</br>`);

//Print Total Sales section
document.write(`<h2>Total Sales</h2>`);
document.write(`<br>$${TotalSale}</br>`);
